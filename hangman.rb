...
class Hangman
  ...
  # Comment line below to show/hide answer for testing purposes
  #  puts @answer
...
# Generates art/prompts for user interface
  def user_prompt
    ...
    until @answer == @answer_output
      ...
      # After user enters input, check to see if input is valid
      check_user_input
...
# Checks user input to make sure input is a single letter
